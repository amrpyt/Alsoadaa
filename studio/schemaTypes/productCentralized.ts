...
export const productCentralizedType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        {name: 'january', type: 'boolean', title: 'Jan'},
        {name: 'february', type: 'boolean', title: 'Feb'},
        {name: 'march', type: 'boolean', title: 'Mar'},
        {name: 'april', type: 'boolean', title: 'Apr'},
        {name: 'may', type: 'boolean', title: 'May'},
        {name: 'june', type: 'boolean', title: 'Jun'},
        {name: 'july', type: 'boolean', title: 'Jul'},
        {name: 'august', type: 'boolean', title: 'Aug'},
        {name: 'september', type: 'boolean', title: 'Sep'},
        {name: 'october', type: 'boolean', title: 'Oct'},
        {name: 'november', type: 'boolean', title: 'Nov'},
        {name: 'december', type: 'boolean', title: 'Dec'},
      ],
    }),
    defineField({
      name: 'packaging',
