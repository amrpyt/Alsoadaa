      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-white font-semibold mb-4 text-xl">Contact Us</h4>
          ...
          <div className="flex flex-col justify-end">
            <h4 className="text-white font-semibold mb-4 text-xl text-center lg:text-left">Our Location</h4>
            <div className="w-full rounded-lg overflow-hidden" style={{ height: '280px' }}>
              <iframe 
                ...
                title="Al Soadaa Company Location"
              />
            </div>
          </div>
        </div>
