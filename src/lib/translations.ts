...
export const translations: Record<Language, Translations> = {
  ...
  ar: {
    ...
    // Processing Pages - Sorting
    sortingDesc: 'تتم عملية الفرز من خلال عدة مراحل لضمان أعلى جودة.',
    sortingStage1Title: 'المرحلة الأولى:',
    sortingStage1Desc: 'في هذه المرحلة، يتم استبعاد الثمار المكسورة والتالفة.',
    sortingStage2Title: 'المرحلة الثانية:',
    sortingStage2Desc: 'تأتي هذه المرحلة بعد غسل الثمار باستخدام مياه الشرب. يتم فيها استبعاد جميع العيوب الفسيولوجية والميكانيكية.',
    sortingStage3Title: 'المرحلة الثالثة:',
    sortingStage3Desc: 'تتم هذه المرحلة بعد عملية التشميع. يتم فيها فحص جميع الخطوات المذكورة سابقاً. تتم عملية الفرز بواسطة مجموعة من العمال المهرة ذوي الخبرة العالية في مجال فرز المحاصيل الزراعية.',
    sortingKeyBenefits: 'المزايا الرئيسية',
    sortingBenefit1: 'عملية مراقبة جودة متعددة المراحل',
    sortingBenefit2: 'فريق فرز ذو خبرة عالية',
    sortingBenefit3: 'ضمان جودة ممتازة للثمار فقط',
    sortingBenefit4: 'عملية غسيل وتشميع متقدمة',
    sortingImageCaption: 'خط فرز متطور يضمن جودة ممتازة',

    // Processing Pages - Packing
    packingDesc1: 'تسبق عملية التعبئة عملية التحجيم، والتي تتم بواسطة ماكينة التحجيم (Caesar). تقوم هذه الآلة بتوزيع الثمار وفقاً للأحجام في حوض التعبئة المناسب لها.',
    packingDesc2: 'من أجل إجراء التعبئة النهائية للثمار داخل الكرتون بطريقة تضمن دقة وجودة التعبئة المطلوبة للأسواق.',
    packingDesc3: 'يتم إغلاق الكراتين ميكانيكياً بواسطة ماكينة لصق، والتي تستخدم لإغلاق الكرتون بإحكام وضمان وصوله الآمن للعميل.',
    packingFeature1Title: 'تحجيم آلي',
    packingFeature1Desc: 'ماكينة Caesar لتحجيم دقيق',
    packingFeature2Title: 'تعبئة عالية الجودة',
    packingFeature2Desc: 'تعبئة كرتون دقيقة',
    packingFeature3Title: 'إغلاق محكم',
    packingFeature3Desc: 'ماكينة لصق ميكانيكية',
    packingStandards: 'معايير التعبئة',
    packingStandard1: 'تحجيم آلي لضمان التناسق',
    packingStandard2: 'أحواض تعبئة مناسبة للأحجام',
    packingStandard3: 'إغلاق ميكانيكي للكرتون',
    packingStandard4: 'جودة تغليف جاهزة للسوق',
    ...
    exportingFeature2Title: 'أفضل خطوط الشحن',
    exportingFeature2Desc: 'شراكة مع شركات شحن رائدة',
    exportingFeature3Title: 'جودة ممتازة',
    exportingFeature3Desc: 'أجود المحاصيل الزراعية المصرية',
    exportingFeature4Title: 'خدمة موثوقة',
    exportingFeature4Desc: 'موثوق بنا من قبل عملاء دوليين',
    exportingCapabilities: 'قدرات التصدير',
    exportingCap1: 'جميع أنواع الفواكه والخضروات',
    exportingCap2: 'تغطية شحن لجميع أنحاء العالم',
    exportingCap3: 'التعاون مع أفضل خطوط الشحن',
  ...
  ru: {
    ...
    // Processing Pages (Fallback to English for now)
    sortingDesc: 'Sorting process is done through several stages.',
    sortingStage1Title: 'The First stage:',
    sortingStage1Desc: 'At this stage, broken and damaged fruits are excluded.',
    sortingStage2Title: 'The Second stage:',
